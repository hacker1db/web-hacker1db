...
export const siteConfig: SiteConfig = {
  ...
  keywords:
    "Homepage, Blog, Programming, Cyber Security, DevSecOps, Music, Travel, Coffee",
  ...
  footer: {
    ...
    right:
      "Powered by <a href='https://nextjs.org/'>Next.js</a>, and <a href='https://github.com'>GitHub</a>",
  },
};
